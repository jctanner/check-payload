...
var (
	...
	ErrPythonCryptoNotLinkedToSystem  = errors.New("python cryptography module does not link to system libcrypto")
	ErrPythonCryptoNotDynamicLinked   = errors.New("python cryptography module is not dynamically linked")
	ErrPythonCryptoMultipleLibcrypto  = errors.New("python cryptography module links to multiple libcrypto versions")
	ErrPythonCryptoBundledLibrary     = errors.New("python cryptography module uses bundled cryptography library")
)
